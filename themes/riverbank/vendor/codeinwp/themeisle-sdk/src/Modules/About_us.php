...
class About_Us extends Abstract_Module {
	...
	private function get_about_localization_data() {
		...
		return [
			...
			'strings'        => [
				'aboutUs'          => __( 'About us', 'riverbank' ),
				'heroHeader'       => __( 'Our Story', 'riverbank' ),
				'heroTextFirst'    => __( 'Themeisle was founded in 2012 by a group of passionate developers who wanted to create beautiful and functional WordPress themes and plugins. Since then, we have grown into a team of over 20 dedicated professionals who are committed to delivering the best possible products to our customers.', 'riverbank' ),
				'heroTextSecond'   => __( 'At Themeisle, we offer a wide range of WordPress themes and plugins that are designed to meet the needs of both beginners and advanced users. Our products are feature-rich, easy to use, and are designed to help you create beautiful and functional websites.', 'riverbank' ),
				'teamImageCaption' => __( 'Our team in WCEU2022 in Portugal', 'riverbank' ),
				'newsHeading'      => __( 'Stay connected for news & updates!', 'riverbank' ),
				'emailPlaceholder' => __( 'Your email address', 'riverbank' ),
				'signMeUp'         => __( 'Sign me up', 'riverbank' ),
				'installNow'       => __( 'Install Now', 'riverbank' ),
				'activate'         => __( 'Activate', 'riverbank' ),
				'learnMore'        => __( 'Learn More', 'riverbank' ),
				'installed'        => __( 'Installed', 'riverbank' ),
				'notInstalled'     => __( 'Not Installed', 'riverbank' ),
				'active'           => __( 'Active', 'riverbank' ),
			],
		];
	}
	...
	private function get_other_products_data() {
		$products = [
			...
			'neve'                                => [
				'skip_api'    => true,
				'name'        => 'Neve',
				'description' => __( 'A fast, lightweight, customizable WordPress theme offering responsive design, speed, and flexibility for various website types.', 'riverbank' ),
			...
			'wp-landing-kit'                      => [
				...
				'name'        => 'WP Landing Kit',
				'description' => __( 'Turn WordPress into a landing page powerhouse with Landing Kit, map domains to pages or any other published resource.', 'riverbank' ),
			...
			'sparks-for-woocommerce'              => [
				...
				'name'        => 'Sparks',
				'description' => __( 'Extend your store functionality with 8 ultra-performant features like product comparisons, variation swatches, wishlist, and more.', 'riverbank' ),
				'icon'        => $this->get_sdk_uri() . 'assets/images/sparks.png',
				'condition'   => class_exists( 'WooCommerce', false ),
			],
			'templates-patterns-collection'       => [
				'name'        => 'Template Cloud',
				'description' => __( 'Ultimate Free Templates Cloud for WordPress, for blocks, patters of full pages.', 'riverbank' ),
			],
		];
